...
{
    public partial class ReclassDirectProcessDocPrintSum : Form
    {
        ...
        public ReclassDirectProcessDocPrintSum()
        {
            InitializeComponent();
        }

        private void ReclassDirectProcessDocPrintSum_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", DocDetails.Tables["ReclassLineDetail"]));
