...
{
    public partial class GenericOUTProcessDocPrint : Form
    {
        ...
        public GenericOUTProcessDocPrint()
        {
            InitializeComponent();
        }

        private void GenericOUTProcessDocPrint_Load(object sender, EventArgs e)
        {
