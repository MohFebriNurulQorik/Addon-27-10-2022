...
{
    public partial class GenericINProcessDocPrint : Form
    {
        ...
        public GenericINProcessDocPrint()
        {
            InitializeComponent();
        }

        private void GenericINProcessDocPrint_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", DocDetails.Tables["ProcessingLineINDetail"]));
            this.reportViewer1.LocalReport.SetParameters(new ReportParameterCollection() { parCompany, parWarehouse, parAddress, parPhone, parDocNbr, parDocType, parDocDate, parDocStatus, parQRImage });
