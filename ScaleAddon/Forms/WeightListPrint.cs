...
{
    public partial class WeightListPrint : Form
    {
        ...
        public WeightListPrint()
        {
            InitializeComponent();
        }

        private void WeightListPrint_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.SetParameters(new ReportParameterCollection() { parCompany, parWarehouse, parAddress, parPhone, parDocNbr, parDocType, parDocStatus, parDispatchDate, parQRImage, parFromTo, parLogisticService, parLisencePlate });
