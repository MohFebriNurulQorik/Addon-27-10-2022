...
{
    public partial class DirectPackingDocSumPrint : Form
    {
        ...
        public DirectPackingDocSumPrint()
        {
            InitializeComponent();
        }

        private void DirectPackingDocSumPrint_Load_1(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", DocDetails.Tables["DirectPackingLineDetail"]));
