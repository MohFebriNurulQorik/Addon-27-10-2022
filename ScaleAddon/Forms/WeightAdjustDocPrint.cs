...
{
    public partial class WeightAdjustDocPrint : Form
    {
        ...
        public WeightAdjustDocPrint()
        {
            InitializeComponent();
        }

        private void WeightAdjustDocPrint_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", DocDetails.Tables["WeightAdjustLineDetail"]));
