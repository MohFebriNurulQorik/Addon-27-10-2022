...
{
    public partial class PackLotPrint : Form
    {
        ...
        private void PackLotPrint_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.SetParameters(new ReportParameterCollection() { parLotNbr, parSource, parStalkPos, parFerment, parBuyer, parInventoryID, parProcess, parStage, parGrade, parColor, parWeight, parLength, parWarehouse, parDate, parQRImage, parRemark, parArea, parArea, parStrCrop });
