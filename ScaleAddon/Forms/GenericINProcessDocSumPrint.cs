...
{
    public partial class GenericINProcessDocSumPrint : Form
    {
        ...
        public GenericINProcessDocSumPrint()
        {
            InitializeComponent();
        }

        private void GenericINProcessDocSumPrint_Load(object sender, EventArgs e)
        {
