...
{
    public partial class ReclassProcessDocPrintSum : Form
    {
        ...
        public ReclassProcessDocPrintSum()
        {
            InitializeComponent();
        }

        private void ReclassProcessDocPrintSum_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", DocDetails.Tables["ReclassProcessLineDetail"]));
