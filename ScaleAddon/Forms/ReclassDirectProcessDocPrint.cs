...
{
    public partial class ReclassDirectProcessDocPrint : Form
    {
        ...
        public ReclassDirectProcessDocPrint()
        {
            InitializeComponent();
        }

        private void ReclassDirectProcessDocPrint_Load(object sender, EventArgs e)
        {
