...
{
    public partial class DirectPackingV2 : Form
    {
        ...
        private void loadEntry(string LotNbr)
        {
            ...
            using (SqlConnection connection = new SqlConnection(ConnectionString))
            {
                ...
                try
                {
                    ...
                    //cbEntryGrade.SelectedIndex = cbEntryGrade.
                    //
                    //
                    //
                    //dtEntry.Rows[0].ItemArray[8].ToString());
        ...
        private void setLotNbr()
        {
            ...
            string lotnbr = $"{Math.Abs(FiscalInfo.CurrentFiscalYear) % 100}{Warehouse.WarehouseID}-{tbEntryInv.Text}{tbEntrySource.Text}PC{tbEntryForm.Text}{currentLotIncrement.ToString().PadLeft(5, '0')}";
