...
{
    public partial class ucReturnBuying : UserControl
    {
        ...
        private void ucProcessingINGeneric_Load(object sender, EventArgs e)
        {
            ...
            Dock = DockStyle.Fill;
            ParentForm.Text = $"Universal Leaf [{Warehouse.Descr}] - {tempProcessDescr} Return Buying List";
        ...
        private void LoadData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(ConnectionString))
            {
                ...
                try
                {
                    ...
                    dgvList.Columns[6].HeaderText = "Acumatica Ref Number";
                    ...
                    dgvList.Columns[11].HeaderText = "Notes";
                    dgvList.Columns[12].HeaderText = "Buying Ref";
        ...
        {
            Forms.ReturnBuying genericReturnBuying = new Forms.ReturnBuying
            {
                Warehouse = Warehouse,
            ...
            genericReturnBuying.ShowDialog();
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            {
                Forms.ReturnBuying genericBuying = new Forms.ReturnBuying
                {
                    Warehouse = Warehouse,
                    ConnectionString = ConnectionString,
                    AcumaticaCred = AcumaticaCred,
