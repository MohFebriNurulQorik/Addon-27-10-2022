...
{
    public partial class ucDirectTempPacking : UserControl
    {
        ...
        public ucDirectTempPacking()
        {
            InitializeComponent();
        }

        private void ucDirectTempPacking_Load(object sender, EventArgs e)
        {
            Dock = DockStyle.Fill;
            ParentForm.Text = $"Universal Leaf [{Warehouse.Descr}] - Direct Temporary Packing List";
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            {
                Forms.DirectTempPacking directTempPacking = new Forms.DirectTempPacking
                {
                    Warehouse = Warehouse,
