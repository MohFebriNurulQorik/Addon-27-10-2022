...
{
    public partial class ucProcessingINGeneric : UserControl
    {
        ...
        {
            Dock = DockStyle.Fill;
            ParentForm.Text = $"Universal Leaf [{Warehouse.Descr}] - {tempProcessDescr} IN Process List";
        ...
        {
            Forms.GenericINProcess genericINProcess = new Forms.GenericINProcess
            {
                Warehouse = Warehouse,
        ...
        private void btnBatchSync_Click(object sender, EventArgs e)
        {
            Forms.BatchAcumaticaSync batchAcumaticaSync = new Forms.BatchAcumaticaSync
            {
                ...
                HeaderTable = "ProcessingLineIN",
                DetailTable = "ProcessingLineINDetail",
                AcumaticaReasonCode = AcumaticaReasonCode
            };
