...
{
    public partial class ucDispatchIN : UserControl
    {
        ...
        private void ucDispatchIN_Load(object sender, EventArgs e)
        {
            Dock = DockStyle.Fill;
            ParentForm.Text = $"Universal Leaf [{Warehouse.Descr}] - Dispatch IN List";
        ...
        private void LoadData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(ConnectionString))
            {
                ...
                try
                {
                    ...
                    dgvList.Columns[7].HeaderText = "Acumatica Receipt";
                    dgvList.Columns[8].HeaderText = "Transakasi Type";
                    dgvList.Columns[8].Visible = false;
                    dgvList.Columns[9].HeaderText = "Note";
                    dgvList.Columns[9].Visible = false;
                    dgvList.Columns[10].HeaderText = "Dispatch OUT Nbr";
                    dgvList.Columns[11].HeaderText = "Created By";
                    dgvList.Columns[12].HeaderText = "Created Date";
                    dgvList.Columns[13].HeaderText = "Modified date";
                    dgvList.Columns[14].HeaderText = "Logistic";
                    dgvList.Columns[14].Visible = false;
                    dgvList.Columns[15].HeaderText = "Lisence Plate";
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            {
                Forms.DispatchINProcess dispatchINProcess = new Forms.DispatchINProcess
                {
                    Warehouse = Warehouse,
