...
{
    public partial class ucReclassProcess : UserControl
    {
        ...
        public ucReclassProcess()
        {
            InitializeComponent();
        }

        private void ucReclassProcess_Load(object sender, EventArgs e)
        {
            Dock = DockStyle.Fill;
            ParentForm.Text = $"Universal Leaf [{Warehouse.Descr}] - Regrade List";
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            {
                Forms.ReclassProcess reclassProcess = new Forms.ReclassProcess
                {
                    Warehouse = Warehouse,
