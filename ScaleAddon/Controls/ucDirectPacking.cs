...
{
    public partial class ucDirectPacking : UserControl
    {
        ...
        public ucDirectPacking()
        {
            InitializeComponent();
        }

        private void ucDirectPacking_Load(object sender, EventArgs e)
        {
            Dock = DockStyle.Fill;
            ParentForm.Text = $"Universal Leaf [{Warehouse.Descr}] - Direct Packing List";
        ...
        {
            if (Userlog.UserRoles.Contains("M1"))
            {
                if (dgvList.SelectedRows.Count > 0)
                {
                    Forms.DirectPacking directPacking = new Forms.DirectPacking
                    {
                        Warehouse = Warehouse,
                ...
                if (dgvList.SelectedRows.Count > 0)
                {
                    Forms.DirectPackingV2 directPackingv2 = new Forms.DirectPackingV2
                    {
                        Warehouse = Warehouse,
                        ConnectionString = ConnectionString,
                        AcumaticaCred = AcumaticaCred,
