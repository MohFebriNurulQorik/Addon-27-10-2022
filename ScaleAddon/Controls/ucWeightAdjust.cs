...
{
    public partial class ucWeightAdjust : UserControl
    {
        ...
        public ucWeightAdjust()
        {
            InitializeComponent();
        }

        private void ucWeightAdjust_Load(object sender, EventArgs e)
        {
            Dock = DockStyle.Fill;
            ParentForm.Text = $"Universal Leaf [{Warehouse.Descr}] - Weight Adsjustment List";
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            {
                Forms.WeightAdjustment weightAdjustment = new Forms.WeightAdjustment
                {
                    Warehouse = Warehouse,
