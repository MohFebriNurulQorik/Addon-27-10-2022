...
namespace Microsoft.Reporting.WinForms
{
    public static class LocalReportExtensions
    {
        public static void PrintToPrinter(this LocalReport report)
        {
            ...
            {
                pageSettings.PaperSize.Height = report.GetDefaultPageSettings().PaperSize.Width;
                pageSettings.PaperSize.Width = report.GetDefaultPageSettings().PaperSize.Height;
